...
export type ProductQuery = { __typename: 'Query', product?: { __typename: 'Product', id: string, title: string, companyName: string, website?: string, appStoreLink?: string, playStoreLink?: string, established: number, founders?: string, numberOfEmployees?: number, story: string, productFeatures?: Array<string>, valueChain?: Array<string>, originalAsk: string, productImage?: string, informationImage?: string, categories: Array<string>, season: number, episode: number, precedence: number, createdAt?: string, marketPlace?: Array<{ __typename: 'MetaData', name: string, value: string }>, sales?: Array<{ __typename: 'MetaData', name: string, value: string }>, salesSplit?: Array<{ __typename: 'MetaData', name: string, value: string }>, unitEconomics?: Array<{ __typename: 'UnitEconomics', name: string, amount: number }>, statistics?: Array<{ __typename: 'MetaData', name: string, value: string }>, counterOffer?: Array<{ __typename: 'Deal', sharkName: string, amount: string, valuation: string, equity: number, debt?: number, debtInterest?: number }>, dealClosed?: { __typename: 'Deal', sharkName: string, amount: string, valuation: string, equity: number, debt?: number, debtInterest?: number } } | { __typename: 'ServerError', message: string } | { __typename: 'ValidationError', message: string, data: Array<{ __typename: 'ValidationErrorField', field: string, errorMessages: Array<string> }> } };
