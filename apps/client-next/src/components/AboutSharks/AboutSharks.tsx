          ...
          <Row>
            ...
            <Col md="6">
              ...
              <p className="mt-0 p-0 text-align-justify">
                ...
                couldn&apos;t find any information that suggests he has appeared
                on the Indian version of &quot;Shark Tank&quot;, however. If
                you&apos;re looking for information on entrepreneurs who have
                appeared on the Indian version of &quot;Shark Tank&quot;, you
                may want to check out the show&apos;s official website or do a
                search for &quot;Shark Tank India&quot; or &quot;Shark Tank
                India entrepreneurs&quot;.
              </p>
            </Col>
          </Row>
          ...
          <Row>
            ...
            <Col md="6">
              ...
              <p className="mt-0 p-0 text-align-justify">
                ...
                leading eyewear retailers in India.
                <br /> Peyush Bansal was born in India and received his
                education in computer science and engineering. Prior to founding
                Lenskart, he worked in several technology-focused companies in
                India and the United States.Peyush Bansal is known for his
                entrepreneurial spirit and his ability to bring innovative ideas
                to the eyewear market. Under his leadership, Lenskart has become
                a well-known and respected brand in India, and has helped to
                revolutionize the way people purchase eyewear.
              </p>
            </Col>
          </Row>
        </Container>
        <Container className="mt-4">
          <Row>
            ...
            <Col md="6">
              ...
              <p className="mt-0 p-0 text-align-justify">Namita thapar info</p>
            </Col>
          </Row>
        </Container>
        <Container className="mt-4">
          <Row>
            ...
            <Col md="6">
              ...
              <p className="mt-0 p-0 text-align-justify">Vineeta Singh Info</p>
            </Col>
          </Row>
        </Container>
        <Container className="mt-4">
