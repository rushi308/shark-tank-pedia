          ...
          <div className="row blog-entries element-animate">
            <div className="col-md-12">
              <p>
                ...
                you need more information about our privacy policy or if you
                have any other questions. The information shared and/or
                collected in Shark Tank Pedia by visitors to our website is
                subject to the terms of this Privacy Policy, which only relates
                to our online activities. Any information gathered offline or
                through sources other than this website is not covered by this
                policy.
              </p>
            </div>
            <div className="col-md-12">
