            ...
            <div className="row blog-entries element-animate">
              ...
              <div className="col-md-12">
                ...
                <p>
                  ...
                  the information you discover on this website (Shark Tank
                  Pedia). Shark Tank Pedia disclaims all responsibility for any
                  losses and/or damages arising from the use of this website.
                  <br />
                  <br />
                  By clicking on links to these external websites from our
                  website, you can visit other websites. While we make an effort
                  to only connect to trustworthy and ethical websites, we have
                  no control over their content or general nature. These
                  references to other websites do not imply endorsement of all
                  the information contained therein. Before we have a chance to
                  delete a link that may have gone &quot;bad,&quot; site owners
                  and content are subject to change without prior notice.
                  <br />
                  <br />
                  Moreover, be aware that we have no control over the privacy
                  policies and agreements of other websites that you may visit
                  after leaving ours. Before conducting any business or
                  uploading any information, please be sure to review the
                  &quot;Terms of Service&quot; and the Privacy Policies of these
                  websites.
                </p>
              </div>
              <div className="col-md-12">
              ...
              <div className="col-md-12">
                ...
                <p>
                  ...
                  document will be clearly noted here. If you would like to get
                  in touch with us, you can do so by sending an email to
